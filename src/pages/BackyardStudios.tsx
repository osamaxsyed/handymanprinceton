...
const BackyardStudios = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We build backyard studios across Central New Jersey: Princeton, Plainsboro, West Windsor, Lawrence Township, Montgomery, Skillman, Hopewell Borough, Pennington, Rocky Hill, Kingston, South Brunswick, Robbinsville, East Windsor, and surrounding Mercer County towns.",
    },
  ];
