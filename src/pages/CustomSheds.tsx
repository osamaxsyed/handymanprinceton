...
const CustomSheds = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We build sheds across Central New Jersey: Princeton, South Brunswick, Cranbury, Plainsboro, East Windsor, West Windsor, Lawrence Township, Robbinsville, Pennington, and Montgomery, and surrounding Mercer County towns.",
    },
  ];
